...
1. select **More info**
2. then select **Run anyway** if you trust the file source
...
- If it is an `.exe` file, double-click it to start the app

### 3. Allow Windows to finish setup
